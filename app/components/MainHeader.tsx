...
export default async function MainHeader({activeTab}) {

    return (
      <div className="bg-gray-900 shadow-md z-40 fixed top-0 left-0 w-full  flex items-center justify-between px-2 text-white lg:px-20 md:px-10 sm:px-5 relative ">
        <a href="/"><img className="h-[60px] my-3 aspect-square mr-10" alt="logo" src="/hdlogo.svg"/></a>
        <ul className=" hidden md:flex  flex-row list-none gap-8 text-md font-bold">
