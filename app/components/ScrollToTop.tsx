...
export default function ScrollToTop() {
  ...
  if(visible) {
    return (
      <div onClick={()=>{scrollmetoTop()}} className="cursor-pointer hover:bg-gray-900 fixed bottom-[20px] right-[20px] w-12 h-12 bg-black shadow-md rounded-md flex items-center justify-center z-40">
